    ...
    card.innerHTML = `
      ...
      <div class="product-info">
        ...
        <div class="product-price-btn">
          ...
          <button class="btn-buy" onclick="alert('Produto \'${product.title}\' adicionado ao carrinho!')">Comprar</button>
        </div>
      </div>
    `;
...
// Garante que o script rode quando todo o HTML estiver carregado na tela
